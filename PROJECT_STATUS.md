...
## 最終更新
- 更新日: 2026/09/19
- 更新概要: perception_node の YOLOv8m 化、推論 15Hz 化、MJPEG 配信 15fps 化、レターボックス前処理、複数フレーム確認でカメラ物体検出の精度と CPU 負荷を改善。以前:
...
- AI HAT+ 推論: YOLOv8m、640x640 にレターボックスして 15Hz 設定（推論タイマー 0.02秒）。実測 8.28〜8.34Hz、推論 29.3〜33.7ms、CPU 36.0〜41.3%、camera_node 約50.7%、CPU 55.4〜57.6℃、Hailo 50.3〜50.6℃、サーマル状態 normal
